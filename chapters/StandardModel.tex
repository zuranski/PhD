...
Thus far, the SM proves to be self-consistent with only insignificant tensions between
...
new particles, while the SM symmetry group $\text{SU}(3)_\text{C} \times \text{SU}(2)_\text{L} \times \text{U}(1)_\text{Y}$ 
...
$v$-confinement scale $\Lambda_v$, resembling the SM colour group,
