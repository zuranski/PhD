...
%For mass of 400 \GeVcc the 
%difference between signal models with \X mass of 50 \GeVcc and 150 \GeVcc comes from the fact of overall 
%underestimation of the total $H_T$ for \X of mass 150 \GeVcc. The mean $H_T$ for this sample falls below 
%325 \GeV, which is used as an offline cut, therefore making the efficiency more sensitive to jet energy scale
%variations. The underestimation of jet energies for \X of mass 150 \GeVcc is due to the fact
...
%The effect of $H_T$ underestimation for \X mass of 150 \GeVcc does not depend on the \X particle mean lifetime.
