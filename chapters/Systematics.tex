...
a function of the number of primary pileup vertices is shown in Figure \ref{fig:effPU}. No significant
...
reconstructed \Kshort candidates as a function of pileup is presented in Figure \ref{fig:kspileup}.
...
In the preselection criteria the tracks in the displaced dijet vertex are required to have on average
 fewer than two missing hits behind the vertex position. The efficiency of this requirement is above 98\% 
...
hits behind the vertex position in a control sample of prompt dijets in data and simulation. We apply the selection criteria that are analogous to the selection criteria applied to the signal
dijets,
...
not bigger than 300$\mum$
 with respect to the leading primary vertex. Figure \ref{fig:eff2Trks} shows the single jet efficiency for passing
...
to accept the event and examine a single jet efficiency with respect to prompt charged energy
 ...
 as those having the transverse impact parameter not bigger than 500\micron. 
Using transverse impact parameter
minimizes the sensitivity to additional pileup interactions in the event. The size of the luminous region in 
the transverse plane is very small, about 15\micron, therefore the track promptness definition is general
