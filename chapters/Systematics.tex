...
a function of the number of primary pile-up vertices is shown in Figure \ref{fig:effPU}. No significant
...
the relative tracking efficiency as a function of displacement and pile-up using
...
a source of \Kshort decays in a jet environment. The pile-up distribution in simulation is reweighted
