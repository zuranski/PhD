...
The only significant background is expected to arise from multijet events, and the corresponding simulated samples
...
\begin{tabular}{|c|c|c|}
\hline 
  $M_{\Higgs}$ (\GeVcc) & $M_{\X}$ (\GeVcc) & $c\tau$ (cm) \\
\hline
       1000      &       350      &     3.5, 35, 350      \\          
       1000      &       150      &     1, 10, 100      \\          
       1000      &        50      &     0.4, 4, 40      \\          
...
% Weights taken from Kristian's output log file.
% Cross-sections sampleXSec taken from UserCode/DisplacedLeptons/Samples/python/samples/
