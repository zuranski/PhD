...
\item In a second algorithm we search for clustering of the $L_{xy}$ values from the tracks in the jets.
...
are different the value of the cluster RMS is greatly increased, see Figure \ref{fig:discclr}.
\begin{equation}
...
in the signal region. Figures \ref{fig:promptness} through % \ref{fig:discriminant}, \ref{fig:vertex} 
